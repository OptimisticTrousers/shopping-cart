...
describe("CartItem", () => {
    ...
    it("correctly calculating subtotal", () => {
        ...
        const cartSubtotal = Store.useCart().reduce((prevValue, currentValue) => prevValue + currentValue.price, 0).toString()
        ...
        expect(subTotal.textContent).toBe(cartSubtotal)
    })
    it("correctly calculating tax", () => {
        ...
        const cartSubtotal = Store.useCart().reduce((prevValue, currentValue) => prevValue + currentValue.price, 0)
        ...
        expect(tax.textContent).toBe(`+ ${cartTax}`)
    })
    ...
    it("correctly calculating total", () => {
        ...
        expect(total.textContent).toBe(cartTotal.toString())
    })
